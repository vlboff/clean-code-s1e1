...
var editTask=function(){
    ...
    console.log("Change 'section__button_edit' to 'save'");
    ...
    //If class of the parent is .section__item_edit
    if(containsClass){

        //switch to .section__item_edit
    ...
    //toggle .section__item_edit on the parent.
